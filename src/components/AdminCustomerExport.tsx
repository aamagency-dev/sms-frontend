...
const AdminCustomerExport: React.FC<{ businesses: Business[] }> = ({ businesses }) => {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      link.href = url;
      link.setAttribute('download', `${businessName}_customers_export_${new Date().toISOString().split('T')[0]}.csv`);
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold mb-6">Export Customers (Admin)</h2>
